...
/* Solar PV Design Platform v1.9 - electrical engine
   Retained from the verified v1.7 deterministic engine; v1.9 adds explicit engineering-rule-pack inputs without replacing the established string/MPPT design path. */
