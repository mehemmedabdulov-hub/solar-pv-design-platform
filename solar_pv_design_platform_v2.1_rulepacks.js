...
/* Solar PV Design Platform v2.1 - formal rule-pack contract.
...
(function initSolarPVRulePackContract(global) {
  const CONTRACT_MODULE_VERSION = "2.1.0";
  ...
  if (!v19 || v19.version !== V19_ENGINE_VERSION) {
    throw new Error("SolarPVRulePackContract v2.1 requires the frozen SolarPVRulePacks v1.9.0 module to load first.");
  }
  ...
  function makeCapabilities() {
    const unsupportedScope = "Not implemented or validated in v2.1; no result may be fabricated from this capability.";
    const map = {};
